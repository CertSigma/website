export default function NumbersStrip() {
  return (
    <div className="numbers-strip" role="region" aria-label="Key statistics">
      <div className="number-item">
        <div className="number-stat"><em>62%</em></div>
        <div className="number-label">of enterprise procurement teams require SOC 2 or ISO 27001 before signing a vendor contract</div>
      </div>
      <div className="number-item">
